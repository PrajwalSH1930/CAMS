...
return (
    ...
    <nav className={`cams-navbar cams-container ${sticky ? 'cams-dark-navbar' :''} text-white`}>
      ...
      <ul className=''>
        <li><Link to='cams-home-section' smooth={true} duration={350} offset={0}>Home</Link></li>
        <li><Link to='about' smooth={true} duration={350} offset={-120}>About</Link></li>
        <li><Link to='cams-programs-section' smooth={true} duration={350} offset={-250}>Programs</Link></li>
        <li><Link to='courses' smooth={true} duration={350} offset={-190}>Courses</Link></li>
        <li><Link to='cams-notice-section' smooth={true} duration={350} offset={-260}>Notice</Link></li>
        <li><Link to='contact' smooth={true} duration={350} offset={-260}>Contact us</Link></li>
